    ...
    with gr.Blocks() as demo:
        ...
        with gr.Tab("编码"):
            with gr.Row():
                ...
                with gr.Column():
                    encoded_output = gr.Textbox(label="Base64 编码", lines=25, interactive=True, show_label=True, show_copy_button=True)
        ...
        with gr.Tab("解码"):
            with gr.Row():
                with gr.Column():
                    decode_input = gr.Textbox(label="输入 Base64 编码文本/图像/音频", lines=29)
                with gr.Column():
                    decode_text_button = gr.Button("解码文本")
                    decoded_text_output = gr.Textbox(label="解码文本", interactive=True, show_label=True, show_copy_button=True)
